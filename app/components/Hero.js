export default function Hero() {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #3e2723 0%, #5d4037 40%, #795548 100%)",
      }}
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-32 md:py-40">
        <div className="max-w-xl">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-white/80 text-xs font-lato tracking-widest uppercase">
          ...
          <p className="text-white/70 font-lato text-base md:text-lg leading-relaxed mb-10 max-w-md">
            Уламжлалт гар урлалыг орчин үеийн технологитой хослуулан таны нандин
            тавилгыг дахин төрхөнд нь оруулна.
          </p>
          ...
          <div className="flex gap-10 mt-14 pt-10 border-t border-white/15">
            {[
              ...
              <div key={stat.label}>
                <div className="font-playfair text-2xl font-bold text-amber-300">
                  {stat.number}
                </div>
                <div className="text-white/50 font-lato text-xs mt-1">
                  {stat.label}
                </div>
              </div>
            ))}
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/40">
        <span className="text-xs font-lato tracking-widest uppercase">
          Доош
        </span>
