        ...
        <div className="grid md:grid-cols-4 gap-10 pb-12 border-b border-stone-700">
          ...
          <div className="md:col-span-1">
            ...
            <p className="font-lato text-stone-400 text-sm leading-relaxed">
              Монгол улсын тавилга сэргэн засварлалтын тэргүүлэгч үйлчилгээ.
              Өмнө ба Дараах.
            </p>
          </div>
          ...
          {/* About */}
          <div>
            <h4 className="font-lato text-xs uppercase tracking-wider text-stone-400 mb-4">
              Холбоосууд
            </h4>
            <ul className="space-y-2">
              {[
                ...
                <li key={l.label}>
                  <a
                    href={l.href}
                    className="font-lato text-sm text-stone-400 hover:text-white transition-colors"
                  >
                    {l.label}
                  </a>
                </li>
