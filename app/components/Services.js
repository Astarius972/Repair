const services = [
  {
    ...
    features: [
      "Итгэл дрос: хонгил",
      "Фигений аргаас ролгайт",
      "Тургачаудрал үнэнтэгэ",
    ],
  },
  {
    icon: (
  ...
  },
  {
    ...
    features: [
      "Концепт дизайн зурах",
      "Элэн зэгэрлүүлэх",
      "Газар дэлгэх хямдлал",
    ],
  },
];
    ...
    <section id="services" className="py-24 bg-stone-50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <p
            className="font-lato text-xs tracking-[0.25em] uppercase text-brown-600 mb-3"
            style={{ color: "#795548" }}
          >
            МАНАЙ ҮЙЛЧИЛГЭЭ
          </p>
          <h2 className="font-playfair text-3xl md:text-4xl font-bold text-stone-800">
            Мэргэжлийн сэргээн засварлалт
          </h2>
          <div
            className="mt-4 mx-auto w-16 h-0.5 bg-amber-600"
            ...
            >
              ...
              <ul className="space-y-2">
                {s.features.map((f) => (
                  <li
                    key={f}
                    className="flex items-center gap-2 text-sm font-lato text-stone-600"
                  >
                    <svg
                      width="14"
                      height="14"
